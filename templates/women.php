<section class="section recent-part" style="margin-top:40px;">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                <div class="section-heading">
                    ...
                    <h2 class="text-left">WOMEN'S<span style="color:#b38504;"> TRENDING</span></h2>
        ...
        <div class="row row-cols-4 row-cols-md-4 row-cols-lg-4 row-cols-xs-6">
            ...
            $sql = "SELECT * FROM product WHERE product.categories = '2' AND product.status = 1 ORDER BY product.id DESC limit 12";
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                <div class="section-btn-25">
                    ...
                    <a href="products" class="btn btn-outline"><i class="fas fa-eye"></i><span>show more</span></a>
