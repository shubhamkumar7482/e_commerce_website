...
$sql="select  sub_categories.*,categories.categories from sub_categories,categories where categories.id=sub_categories.categories";
    ...
    <div class="orders">
        <div class="row">
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="box-link p-2 btn" style="background-color:#f56b23;"><a href="manage_sub_categories.php" style="color:#fff;">Add Sub Categories</a> </h4>
                    </div>
                    <div class="card-body--">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <td>
                                        ...
                                        echo"<span class='badge badge-edit'><a href='manage_sub_categories.php?type=edit&id=".$row['id']."'>Edit</a></span> &nbsp";
